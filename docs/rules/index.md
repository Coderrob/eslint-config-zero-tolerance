...
`eslint-plugin-zero-tolerance` provides **25 custom rules** grouped into seven categories.
...
| [sort-imports](sort-imports.md) | suggestion | Require import declarations to be sorted alphabetically |
| [sort-functions](sort-functions.md) | suggestion | Require top-level function declarations to be sorted alphabetically |
...
| Rule | Type | Description |
|---|---|---|
| [no-relative-parent-imports](no-relative-parent-imports.md) | problem | Ban `../` parent-directory imports and re-exports |

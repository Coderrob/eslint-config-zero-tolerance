...
| [no-indexed-access-types](no-indexed-access-types.md)                               | problem    | Disallow TypeScript indexed access types                                           |
...
| [no-return-type](no-return-type.md)                                                 | problem    | Disallow TypeScript `ReturnType` utility usage                                     |

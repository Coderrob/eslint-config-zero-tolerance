 ...
 */
function enterFunctionScope(parameterStack: Readonly<ParameterScopeStack>, node: Readonly<FunctionNode>): void {
 ...
 */
function exitFunctionScope(parameterStack: Readonly<ParameterScopeStack>, _node: Readonly<FunctionNode>): void {
  parameterStack.pop();
}
 ...
 */
function getFunctionParameterNames(node: Readonly<FunctionNode>): Set<string> {

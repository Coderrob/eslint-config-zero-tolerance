...
describe('sort-functions', () => {
  ruleTester.run('sort-functions', sortFunctions, {
    valid: [
      ...
      {
        name: 'should allow named default exported functions in alphabetical order',
    ...
    invalid: [
      ...
      {
        name: 'should sort named default exported functions without losing implementation text',
        code: [
          ...
          '}',
          '',
          'export default function alpha(input: number): number {',
          '  if (input < 0) {',
          '    return 0;',
          '  }',
          '  return input + 1;',

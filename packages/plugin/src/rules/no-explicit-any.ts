 ...
 */
function checkTsAnyKeyword(
  context: Readonly<NoExplicitAnyContext>,
  node: Readonly<TSESTree.TSAnyKeyword>,
): void {
  context.report({
    node,
 ...
 */
function createNoExplicitAnyListeners(
  context: Readonly<NoExplicitAnyContext>,
...
export const noExplicitAny = createRule({
  ...
  meta: {
    ...
    docs: {
      description:
        'Disallow explicit any; model unknown values precisely and narrow them explicitly',
    },
    messages: {
      noExplicitAny:
